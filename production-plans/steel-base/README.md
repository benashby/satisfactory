...
- **Plastic (84/min) and Rubber (75/min) are imported**, not built here. The
  existing oil factory supplies both and handles the Heavy Oil Residue
  byproduct. This plan starts at the ore.
...
| [`01-smelting.md`](01-smelting.md) | Iron, steel and copper ingots |
